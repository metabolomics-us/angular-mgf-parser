...
MgfParserLibService.ɵfac = function MgfParserLibService_Factory(t) { return new (t || MgfParserLibService)(ɵɵinject(NGXLogger)); };
MgfParserLibService.ɵprov = ɵɵdefineInjectable({ token: MgfParserLibService, factory: MgfParserLibService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { ɵsetClassMetadata(MgfParserLibService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: NGXLogger, decorators: [{
                type: Inject,
                args: [NGXLogger]
            }] }]; }, null); })();

class MgfParserLibModule {
}
MgfParserLibModule.ɵmod = ɵɵdefineNgModule({ type: MgfParserLibModule });
MgfParserLibModule.ɵinj = ɵɵdefineInjector({ factory: function MgfParserLibModule_Factory(t) { return new (t || MgfParserLibModule)(); }, providers: [
        MgfParserLibService
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MgfParserLibModule, { imports: [LoggerModule] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(MgfParserLibModule, [{
        type: NgModule,
        args: [{
                imports: [
                    LoggerModule.forRoot({
...
export { MgfParserLibModule, MgfParserLibService };
//# sourceMappingURL=mgf-parser-lib.js.map
